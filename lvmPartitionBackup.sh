...
# mkdir /mnt/thetest        --> Make a directory to mount the lv you just restored
# mount /dev/mapper/rl-lv5 /mnt/thetest/      ---> Mount the new lv and if you need this persistent do not forget to edit your /etc/fstab file!
